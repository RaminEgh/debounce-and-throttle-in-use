const Pulse = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 my-4">
      <div role="status" className="w-full w-72 max-w-full space-y-8 animate-pulse rtl:space-x-reverse">
        <div className="flex flex-col items-center justify-center w-full h-44 bg-gray-300 rounded dark:bg-gray-700">
